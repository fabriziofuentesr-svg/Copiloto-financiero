      ...
      <div className="w-full max-w-3xl mx-auto">
        ...
        <Card>
          <div className="grid md:grid-cols-[1fr_0.9fr] gap-6">
            <div><h2 className="font-display text-lg font-semibold">Añade una cuenta</h2><p className="text-ink-soft text-sm mt-1 mb-4">Indica tu efectivo, cada cuenta bancaria y tus ahorros. Puedes añadir varias cuentas y usar Bs. 0 en cualquiera. Tus ahorros quedarán vinculados al plan Ahorros sin duplicar dinero.</p><AccountForm submitLabel="Añadir cuenta" /></div>
